...
import org.feisoft.jta.supports.rpc.TransactionRequestImpl;
import org.feisoft.jta.supports.rpc.TransactionResponseImpl;
...
public class TransactionServiceFilter implements Filter {
    ...
    public Result providerInvokeForSVC(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        try {
            ...
            if (transaction!=null  && transaction.getTransactionStatus() == Status.STATUS_ACTIVE) {
