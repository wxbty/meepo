...
public class SharpConnection implements  Connection{
    ...
    public Statement createStatement() throws SQLException {
        ...
        Statement proxySt = (Statement)Proxy.newProxyInstance(ClassLoader.getSystemClassLoader(), new Class[]{Statement.class}, new DynamicStatementProxyHandler(st));
        return proxySt;
    }
